    ...
    public static void main(String[] args) {
        ...
        */
        ...
        try {
            ...
            for (int i=0; i<10; i++)
            {
            textGraphics.putString(i, i, "Lanterna Tutorial 2 - Press ESC to exit", SGR.BOLD);
            textGraphics.setForegroundColor(TextColor.ANSI.RED);
            textGraphics.setBackgroundColor(TextColor.ANSI.WHITE);
            textGraphics.putString(i+1, i, "Terminal Size: ", SGR.BOLD);
            textGraphics.putString(i+2 + "Terminal Size: ".length(), 3, terminal.getTerminalSize().toString());
            }
            //textGraphics.putString(2, 1, "XD");
            /*
